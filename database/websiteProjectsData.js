...
export const websiteProjectsData = [
  {
    ...
    link: "https://supple.space/",
    description:
      "A serene and spacious website for Supple Space, a holistic practice focused on somatic movement, breathwork, and embodied healing. The design reflects the calming ethos of the brand, offering class information, practitioner insights, and a journal section. All optimised for clarity, warmth, and ease of navigation.",
    image: "/web-dev/conor.png",
  },
  {
    year: "June 2025",
    title: "The Taliswoman – Jewellery Brand",
    technologies: ["Next.js", "React", "Tailwind CSS", "Stripe", "Vercel"],
    link: "https://www.thetaliswoman.com/",
    description:
      "An e-commerce platform for Taliswoman, a London-based brand offering handcrafted jewellery. The site features a minimalist design that highlights the artistry of each piece, with an intuitive shopping experience and seamless mobile responsiveness.",
