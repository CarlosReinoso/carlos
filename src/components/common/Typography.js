...
const Typography = ({ variant = "h1", children, className = "" }) => {
  const variants = {
    h1: "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4",
    h2: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold mb-4",
    ...
    body1: "text-base sm:text-lg mb-4",
