...
const Typography = ({ variant = "h1", children, className = "" }) => {
  ...
  const variants = {
    h1: "font-poppins text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-2",
    h2: "font-poppins text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4",
    h3: "font-poppins text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium mb-4",
    ...
    h6: "font-raleway text-white text-base sm:text-lg md:text-xl lg:text-2xl font-bold mb-4",
