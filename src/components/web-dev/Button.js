...
export default function Button({
  ...
  const lightThemeStyles =
    "bg-primary hover:bg-primary hover:bg-gradient-primary";
  ...
  return (
    <div className="mt-4 flex justify-center">
      ...
      >
        <Typography
          variant="body1"
          className="relative inline-block group group-hover:text-third !mb-0 flex items-center gap-2 transition-all duration-300 group-hover:text-third"
        >
          {children}
